-- JEDIDIA Marketplace — Phase 3 schema
...
CREATE TYPE payment_status AS ENUM ('initiated','succeeded','failed','refunded','submitted');
...
CREATE TABLE platform_settings (
  ...
  product_card_orientation VARCHAR(20) DEFAULT 'grid',
